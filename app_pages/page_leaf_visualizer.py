...
def page_leaf_visualizer_body():
    ...
    st.info(
        ...
        f"differentiates a healthy leaf and an infected one.")
    
    version = 'v1'
    if st.checkbox("Difference between average and variability image"):
      
      avg_infected = plt.imread(f"outputs/{version}/avg_var_healthy.png")
      ...
      st.image(avg_uninfected, caption='Uninfected leaf - Average and Variability')
      st.write("---")

    if st.checkbox("Differences between average infected and average uninfected leaf"):
